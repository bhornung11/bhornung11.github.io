...
Figure 2. The Lorenz curve of the pub name distribution (golden ale line) and that of a uniform distribution (amber ale). The half of the ratio of the head coloured area and the are of the triangle is the Gini coefficient.
